...
public class EditUser extends javax.swing.JFrame {
    ...
    public void initComponents2() {
        ...
        input_id.setText(String.valueOf(adminUsers.usuariosDB[userEditNum].getId()));
        input_id.setForeground(Color.white);
        input_id.setEnabled(false);
        input_name.setText(adminUsers.usuariosDB[userEditNum].getName());
        input_name.setForeground(Color.white);
        input_lastname.setText(adminUsers.usuariosDB[userEditNum].getLastname());
        input_lastname.setForeground(Color.white);
        input_user.setText(adminUsers.usuariosDB[userEditNum].getUser());
        input_user.setForeground(Color.white);
        input_user.setEnabled(false);
        input_password.setText(adminUsers.usuariosDB[userEditNum].getPassword());
        input_password.setForeground(Color.white);
        input_password2.setText(adminUsers.usuariosDB[userEditNum].getPassword());
        input_password2.setForeground(Color.white);

        String _rol = adminUsers.usuariosDB[userEditNum].getRol();

        if (_rol.equals("usuario")) {
            input_rol.setSelectedIndex(0);
        } else if (_rol.equals("admin")) {
            input_rol.setSelectedIndex(1);
        }
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(165, 40, -1, -1));
